# Bot Alfa — шаблон телеграм-бота для реферальных заявок

Минимальный каркас, повторяющий логику бота из примера EcoStep: прием заявок по банковским рефералам, логирование действий и простой HTTP-бэкенд для просмотра последних заявок/событий.
